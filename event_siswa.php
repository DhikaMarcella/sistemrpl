    ...
    <section class="container">
        ...
        <div class="event-container" id="eventContainer">
            ...
            ?>
                ...
                <div class="box-produk" data-toggle="modal" data-target="#eventModal" data-image="gallery/<?php echo $hasil['foto_event'] ?>" data-title="<?php echo $hasil['nama_event'] ?>" data-description="<?php echo isset($hasil['deskripsi']) ? $hasil['deskripsi'] : 'No description available'; ?>" data-full-description="<?php echo $hasil['deskripsi']; ?>" data-date="<?php echo $hasil['tanggal']; ?>">
                    <!-- Event image -->
